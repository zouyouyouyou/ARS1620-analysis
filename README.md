...
TPP_Hits_overlapped <- TPP_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(Z_Score_ten_uM) > 2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(Z_Score_hundred_uM) > 2) %>% 
...
TPP_10uM <- ggplot() +
  ...
  # ADK
  geom_point(
    data = subset(TPP_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ADK"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "blue", size = 2.5, alpha = 0.95, shape = 16) +
  geom_text_repel(
    data = subset(TPP_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ADK"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM, label = Gene_Name), size = 5, box.padding = 0.25, point.padding = 0.25, nudge_x = -0.2, nudge_y = 0.2, color = "black", segment.color = "black", segment.size = 0.25, max.overlaps = Inf) +
...
TPP_100uM <- ggplot() +
  # Background
  geom_point(data = TPP_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = Z_Score_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
...
TPP_Hits_overlapped_FC <- TPP_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(log2FC_ten_uM) > 0.2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(log2FC_hundred_uM) > 0.2) %>% 
...
# plot the volcano plots with fold change.
...
TPP_100uM_FC <- ggplot() +
  # Background
  geom_point(data = TPP_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = log2FC_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
...
```r
# read TPP files
TPP_high_Protein = read_excel("/Users/youzou/Desktop/ARS-1620/TPP_higher_temperature/Data/ARS_1620_TPP_high_temperature.xlsx")

# rename the columns
names(TPP_high_Protein)[4] <- "Master_Protein_Accession" 
names(TPP_high_Protein)[9] <- "num_Peptides" 
names(TPP_high_Protein)[10] <- "num_PSMs" 
names(TPP_high_Protein)[11] <- "num_Unique_Peptides" 
names(TPP_high_Protein)[12] <- "num_AAs" 

names(TPP_high_Protein)[18] <- "Control_1" 
names(TPP_high_Protein)[19] <- "Control_2" 
names(TPP_high_Protein)[20] <- "Control_3" 
names(TPP_high_Protein)[21] <- "Control_4" 

names(TPP_high_Protein)[22] <- "ten_uM_1" 
names(TPP_high_Protein)[23] <- "ten_uM_2" 
names(TPP_high_Protein)[24] <- "ten_uM_3" 

names(TPP_high_Protein)[25] <- "hundred_uM_1" 
names(TPP_high_Protein)[26] <- "hundred_uM_2" 
names(TPP_high_Protein)[27] <- "hundred_uM_3" 


TPP_high_Protein_fil <- TPP_high_Protein %>% 
  dplyr::select("Master_Protein_Accession", 9:12, 18:27) %>% 
  # remove missing value
...
# calculate the normalization factor, This normalization step mitigates the TMT channel to channel errors (e.g., differential sample loss and/or isobaric mass tag labeling efficiency). 
TPP_high_norm_1 = sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_2 = sum(TPP_high_Protein_fil$Control_2, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_3 = sum(TPP_high_Protein_fil$Control_3, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_4 = sum(TPP_high_Protein_fil$Control_4, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_5 = sum(TPP_high_Protein_fil$ten_uM_1, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_6 = sum(TPP_high_Protein_fil$ten_uM_2, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_7 = sum(TPP_high_Protein_fil$ten_uM_3, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_8 = sum(TPP_high_Protein_fil$hundred_uM_1, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_9 = sum(TPP_high_Protein_fil$hundred_uM_2, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)
TPP_high_norm_10 = sum(TPP_high_Protein_fil$hundred_uM_3, na.rm = TRUE)/sum(TPP_high_Protein_fil$Control_1, na.rm = TRUE)


TPP_high_Protein_fil_norm <- TPP_high_Protein_fil %>% 
  mutate(Control_1 = Control_1/TPP_high_norm_1) %>% 
  mutate(Control_2 = Control_2/TPP_high_norm_2) %>% 
  mutate(Control_3 = Control_3/TPP_high_norm_3) %>% 
  mutate(Control_4 = Control_4/TPP_high_norm_4) %>% 
  mutate(ten_uM_1 = ten_uM_1/TPP_high_norm_5) %>% 
  mutate(ten_uM_2 = ten_uM_2/TPP_high_norm_6) %>% 
  mutate(ten_uM_3 = ten_uM_3/TPP_high_norm_7) %>% 
  mutate(hundred_uM_1 = hundred_uM_1/TPP_high_norm_8) %>% 
  mutate(hundred_uM_2 = hundred_uM_2/TPP_high_norm_9) %>% 
  mutate(hundred_uM_3 = hundred_uM_3/TPP_high_norm_10) %>% 
  dplyr::select(Master_Protein_Accession, 2:15) 


# Welch t test for TPP file
TPP_high_Protein_fil_norm_Welch_t_test <- TPP_high_Protein_fil_norm %>% 
  rowwise() %>%
  mutate(
    # =======================
    # 10 uM: 6:9 vs 10:12
...
TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name <- TPP_high_Protein_fil_norm_Welch_t_test %>% 
  left_join(
    uniprot_proteome,
    by = "Master_Protein_Accession"
  )
...
# filter for hits
TPP_high_Hits_ten_uM <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(Z_Score_ten_uM) > 2) %>% 
  dplyr::select(Gene_Name) %>% 
  distinct()

TPP_high_Hits_hundred_uM <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(Z_Score_hundred_uM) > 2) %>% 
  dplyr::select(Gene_Name) %>% 
  distinct()

TPP_high_Hits_overlapped <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(Z_Score_ten_uM) > 2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(Z_Score_hundred_uM) > 2) %>% 
...
TPP_high_Hits_overlapped_plot <- TPP_high_Hits_overlapped %>% 
  left_join(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name) %>% 
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(Z_Score_ten_uM) > 2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(Z_Score_hundred_uM) > 2) %>% 
  filter(!Gene_Name == "KRAS") %>% 
  filter(!Gene_Name == "ADK") 

# plot the volcano plots with Z-Score.

# TPP_high_10uM
TPP_high_10uM <- ggplot() +
  # Background
  geom_point(data = TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
  geom_point(data = TPP_high_Hits_overlapped_plot, aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "#4B9CD3", size = 1, alpha = 0.6) +
  # KRAS
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "KRAS"), 
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "red", size = 2.5, alpha = 0.95, shape = 16) +
  geom_text_repel(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "KRAS"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM, label = Gene_Name), size = 5, box.padding = 0.25, point.padding = 0.25, nudge_x = 0.3, nudge_y = 0, color = "black", segment.color = "black", segment.size = 0.25, max.overlaps = Inf) +
  # ADK
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ADK"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "blue", size = 2.5, alpha = 0.95, shape = 16) +
  geom_text_repel(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ADK"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM, label = Gene_Name), size = 5, box.padding = 0.25, point.padding = 0.25, nudge_x = -0.2, nudge_y = 0, color = "black", segment.color = "black", segment.size = 0.25, max.overlaps = Inf) +
  # ALDH1A3
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ALDH1A3"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM), color = "blue", size = 2.5, alpha = 0.95, shape = 16) +
  geom_text_repel(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ALDH1A3"),
    aes(x = Z_Score_ten_uM, y = neg_log10_p_value_ten_uM, label = Gene_Name), size = 5, box.padding = 0.25, point.padding = 0.25, nudge_x = 0, nudge_y = -0.2, color = "black", segment.color = "black", segment.size = 0.25, max.overlaps = Inf) +
  # Thresholds
  geom_hline(yintercept = -log10(0.05), linetype = "33", color = "black", linewidth = 0.25) +
  geom_vline(xintercept = c(-2, 2), linetype = "33", color = "black", linewidth = 0.25) +
  labs(
    x = expression("Z-Score (10 µM)"),y = expression(-log[10]~"(p-value)")) +
  scale_x_continuous(limits = c(-8, 8), breaks = seq(-8, 8, by = 2), labels = scales::number_format(accuracy = 1)) +
...
ggsave("volcano_TPP_high_10uM.png", TPP_high_10uM,
       device = ragg::agg_png, width = 3.45, height = 3.2, units = "in",
       dpi = 600)


# TPP_high_100uM
TPP_high_100uM <- ggplot() +
  # Background
  geom_point(data = TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = Z_Score_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
  geom_point(data = TPP_high_Hits_overlapped_plot, aes(x = Z_Score_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "#4B9CD3", size = 1, alpha = 0.6) +
  # KRAS
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "KRAS"), 
    aes(x = Z_Score_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "red", size = 2.5, alpha = 0.95, shape = 16) +
  ...
  geom_text_repel(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "ALDH1A3"),
    aes(x = Z_Score_hundred_uM, y = neg_log10_p_value_hundred_uM, label = Gene_Name), size = 5, box.padding = 0.25, point.padding = 0.25, nudge_x = 0, nudge_y = -0.2, color = "black", segment.color = "black", segment.size = 0.25, max.overlaps = Inf) +
  # Thresholds
  geom_hline(yintercept = -log10(0.05), linetype = "33", color = "black", linewidth = 0.25) +
  geom_vline(xintercept = c(-2, 2), linetype = "33", color = "black", linewidth = 0.25) +
  labs(
...
ggsave("volcano_TPP_high_100uM.png", TPP_high_100uM,
       device = ragg::agg_png, width = 3.45, height = 3.2, units = "in",
       dpi = 600)
...
# filter for hits
TPP_high_Hits_ten_uM_FC <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(log2FC_ten_uM) > 0.2) %>% 
  dplyr::select(Gene_Name) %>% 
  distinct()

TPP_high_Hits_hundred_uM_FC <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(log2FC_hundred_uM) > 0.2) %>% 
  dplyr::select(Gene_Name) %>% 
  distinct()

TPP_high_Hits_overlapped_FC <- TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name %>%
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(log2FC_ten_uM) > 0.2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
  filter(abs(log2FC_hundred_uM) > 0.2) %>% 
...
TPP_high_Hits_overlapped_plot_FC <- TPP_high_Hits_overlapped_FC %>% 
  left_join(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name) %>% 
  filter(p_value_ten_uM < 0.05) %>% 
  filter(abs(log2FC_ten_uM) > 0.2) %>% 
  filter(p_value_hundred_uM < 0.05) %>% 
...
# TPP_high_10uM_FC
TPP_high_10uM_FC <- ggplot() +
  # Background
  geom_point(data = TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = log2FC_ten_uM, y = neg_log10_p_value_ten_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
  geom_point(data = TPP_high_Hits_overlapped_plot_FC, aes(x = log2FC_ten_uM, y = neg_log10_p_value_ten_uM), color = "#4B9CD3", size = 1, alpha = 0.6) +
  # KRAS
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "KRAS"), 
    aes(x = log2FC_ten_uM, y = neg_log10_p_value_ten_uM), color = "red", size = 2.5, alpha = 0.95, shape = 16) +
...
ggsave("volcano_TPP_high_10uM_FC.png", TPP_high_10uM_FC,
       device = ragg::agg_png, width = 3.45, height = 3.2, units = "in",
       dpi = 600)


# TPP_high_100uM_FC
TPP_high_100uM_FC <- ggplot() +
  # Background
  geom_point(data = TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, aes(x = log2FC_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "grey", size = 0.3, alpha = 0.6) +
  # other proteins
  geom_point(data = TPP_high_Hits_overlapped_plot_FC, aes(x = log2FC_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "#4B9CD3", size = 1, alpha = 0.6) +
  # KRAS
  geom_point(
    data = subset(TPP_high_Protein_fil_norm_Welch_t_test_Gene_Name, Gene_Name == "KRAS"), 
    aes(x = log2FC_hundred_uM, y = neg_log10_p_value_hundred_uM), color = "red", size = 2.5, alpha = 0.95, shape = 16) +
...
ggsave("volcano_TPP_high_100uM_FC.png", TPP_high_100uM_FC,
       device = ragg::agg_png, width = 3.45, height = 3.2, units = "in",
       dpi = 600)
```
