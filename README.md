# ARS1620-analysis
Code and data for reproducing ARS1620 analysis
...
# read uniprot files
uniprot_proteome_Homo_Sapiens <- read_tsv("/Users/youzou/Desktop/ARS-1620/SPROX/Data/uniprotkb_proteome_UP000005640_2024_09_23.tsv") 
...
uniprot_proteome <- uniprot_proteome_Homo_Sapiens %>% 
  ...
  filter(!duplicated(.))
   ...
   # ------------------
   # Analysis of one-pot SPROX data
   # ------------------


# read SPROX files
SPROX_Met_Enrich = read_excel("/Users/youzou/Desktop/ARS-1620/SPROX/Data/ARS_1620_Enrich_non_scale.xlsx")
...
# rename the columns
names(SPROX_Met_Enrich_fil)[6] <- "Control_1"
names(SPROX_Met_Enrich_fil)[7] <- "Control_2"
names(SPROX_Met_Enrich_fil)[8] <- "Control_3"
names(SPROX_Met_Enrich_fil)[9] <- "Control_4"
names(SPROX_Met_Enrich_fil)[10] <- "ten_uM_1"
names(SPROX_Met_Enrich_fil)[11] <- "ten_uM_2"
names(SPROX_Met_Enrich_fil)[12] <- "ten_uM_3"
names(SPROX_Met_Enrich_fil)[13] <- "hundred_uM_1"
names(SPROX_Met_Enrich_fil)[14] <- "hundred_uM_2"
names(SPROX_Met_Enrich_fil)[15] <- "hundred_uM_3"
...
# ------------------
# Analysis of ALDH1A3 Enzymatic Activity
# ------------------
